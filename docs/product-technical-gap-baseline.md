...
Chromium interaction tests. The latest hosted exact-head observation has 3
successful, 11 queued, and 7 skipped check runs with no failure conclusion.
...
evidence, and the latest hosted observation is 2 success, 11 pending, and 7
...
| [#38](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/38) | `93ca6383d2b14c6793ecdfe42c5da1f400168a35` (2026-08-22) | Ready, merge-blocked, review-required | Replacement for closed PR #5. The exact head adds the optional caller-owned atomic JTI replay guard, scope-before-consume ordering, undefined-offset provider-clock rejection, and the ADR 0004 changelog entry; local evidence is 98 passing tests with 100% statement/branch/docstring coverage plus lint/compile/lock/actionlint/Semgrep/pip-audit, while hosted checks are pending (2 success, 11 pending, 7 skipped) and independent approval remains absent. |
