...
Active reviewed security/model/catalog/obligation fix heads: PR #32 `98b37a088029da1cff6c22b8541281f5987f5212`, PR #33 `46388e513aabb30b5dfcc81f29791a4b713f29fc`, PR #37 `6a312a189cadec192c50b4cc5b09804d3a0e97e5`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, PR #40 `4daab149d364f6117e31df22e14e11ad35d230b2`, PR #41 `486a0f8f01f1946e28eb8c20f81f5e714559d0e5`, PR #42 `ba601b625b3a8f4ecad25b58334691017ec36428`, and PR #43 `f41c387c62998de2d136ce8f4a110b4cb22906ac`. This baseline follow-up is PR #39.
...
current exact head `98b37a088029da1cff6c22b8541281f5987f5212` carries the latest
operating-result, owner-graph, migration-SAST, approved-exception, deterministic
ordering, and bounded legacy-identifier fixes. The integrated local suite has
158 tests with 2,398 statements/576 branches and 100% statement/branch/docstring
...
#32. Its current exact head `46388e513aabb30b5dfcc81f29791a4b713f29fc` is aligned
...
head `486a0f8f01f1946e28eb8c20f81f5e714559d0e5` has local 163-test 100%
...
`ba601b625b3a8f4ecad25b58334691017ec36428` renumbers the decision record to
...
| [#32](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/32) | `98b37a088029da1cff6c22b8541281f5987f5212` (2026-08-21) | Ready, stacked, review-required | Internal-control model stacked on #31 for Issue #27. The corrected exact head has 158 tests, 2,398 statements, 576 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; current-head review threads are being reconciled after review fixes, while terminal hosted checks, two approving reviews, and last-push approval remain required. No current PostgreSQL probe is claimed. |
| [#33](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/33) | `46388e513aabb30b5dfcc81f29791a4b713f29fc` (2026-08-21) | Ready, stacked, review-required | Obligation applicability and regulatory-change model stacked on current PR #32 for Issue #28. The corrected exact head has 169 tests, 2,971 statements, 666 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; current-head review threads are being reconciled after review fixes, while the predecessor PostgreSQL probe/hosted results do not transfer and terminal checks, two approvals, last-push approval, and protected merge remain required. |
...
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `486a0f8f01f1946e28eb8c20f81f5e714559d0e5` (2026-08-21) | Draft, stacked, review-required | Replacement for closed PR #36 on current PR #32 head `98b37a088029da1cff6c22b8541281f5987f5212`. The two exact-head Semgrep findings in migration SQL are replaced with SQLAlchemy-safe structured constructs; the branch also carries owner-graph, race, coverage, request-identity, approved-exception, deterministic-ordering, and bounded-identifier fixes. Local 163-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/diff checks, and Semgrep zero-findings evidence pass. New-head Product jobs are successful; SAST/Security/Strix and required workflows are queued, and independent approval remains outstanding. |
| [#42](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/42) | `ba601b625b3a8f4ecad25b58334691017ec36428` (2026-08-21) | Ready, stacked, review-required | Organization OpenTelemetry acceptance-evidence boundary on current PR #32 head `98b37a088029da1cff6c22b8541281f5987f5212`. The exact docs head fixes the ADR sequence to 0012 and, after parent integration, passes the 158-test 100% statement/branch/docstring suite (2,398 statements/576 branches), Ruff, lock, compile, actionlint, diff, and Semgrep zero-findings checks. New-head hosted checks and independent approval remain outstanding. |
