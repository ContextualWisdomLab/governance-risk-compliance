...
| [#55](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/55) | `04a3b42cb76726012803af72e584673d544c25fd` (2026-08-23) | Ready, stacked on #38 | Keyverse HTTP adapter: Bearer RFC 9068 access tokens on policy/evidence routes and officer home, actor-header impersonation rejected, tenant header must match `org`, officer-scoped policy list/gaps/home. Local 103-test 100% statement/branch/docstring evidence. Must stay behind PR #38. Independent review remains the merge blocker. |
...
keep PR #55 stacked on PR #38 at `04a3b42cb76726012803af72e584673d544c25fd`;
