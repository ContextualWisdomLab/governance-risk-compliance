...
Active reviewed security/model/catalog fix heads: PR #36 `43943c7861cd4eef7af11b6f2cf8373afbc0744b`, PR #37 `221af68eb1263d077e7ebcba28611ff54e07e885`, and PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`. This baseline follow-up is PR #39.
...
Its exact head `43943c7861cd4eef7af11b6f2cf8373afbc0744b` has local 157-test,
...
| [#36](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/36) | `43943c7861cd4eef7af11b6f2cf8373afbc0744b` | Draft, stacked, review-required | Review fixes for PR #32 on `feat/internal-control-model`. Local 157-test 100% evidence and PostgreSQL 18.6 upgrade/graph probes pass; Product is green, while required/security gates and independent approval remain outstanding. |
...
| [#39](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/39) | `c6585e4ff89e89e75dd0b3f5eb754ea1035e3d4a` | Draft, stacked, review-required | Current buyer-gap baseline follow-up stacked on PR #35. It records the exact heads and observed boundaries for PR #36, #37, and #38; it remains documentation evidence only, with no independent approval or protected merge. |
