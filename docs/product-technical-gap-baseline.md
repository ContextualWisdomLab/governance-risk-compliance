...
Active operations stack heads: PR #22 `9c1923e8e6f6145d0f789a97db4dd15f94f2adf3` remains open on PR #21's feature branch, and child PR #50 `ba78e4790f3e361826991455ce83634004f2875d` carries the current correlation/severity review repair. PRs #23–#26 and #31 were subsequently merged only into feature branches; their historical records remain below.
...
| [#22](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/22) | `9c1923e8e6f6145d0f789a97db4dd15f94f2adf3` (2026-08-21) | Ready, merge-blocked, review-required | Operational readiness slice stacked on #21; its feature branch now also contains the stack-only PR #23 merge. The current head has no terminal hosted check evidence or independent approval; the earlier `d3f3e515...` local evidence does not transfer. Valid exception-header, router-error, and 5xx logger findings are addressed by child PR #50 and must be integrated through the normal PR path before protected integration. |
| [#50](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/50) | `ba78e4790f3e361826991455ce83634004f2875d` (2026-08-21) | Ready, merge-blocked, review-required | Child of current PR #22 head. The four-file repair preserves Starlette router correlation and exception headers and emits 5xx records at `ERROR`; exact-head local verification is 149 tests, 1,872 statements/474 branches at 100%, Ruff, Interrogate, compileall, actionlint, package build, diff check, and Semgrep zero findings. Hosted checks are queued and no independent approval is present. |
