...
| [#5](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/5) | `0c9c2525918f0f392185942065920c376ef9de28` | Ready, mergeable, review-required | JWT verification is the first direct-to-`develop` security slice. PR #38 carries the current replay-guard fix on the branch. Fresh exact-head Product, SAST, Security, semantic review, branch policy, and independent approval remain required; predecessor evidence does not transfer. |
