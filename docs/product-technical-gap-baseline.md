...
rejection. Product #608 is in progress and SAST/Security #201 are queued;
...
statement/branch/docstring evidence, actionlint, and Semgrep zero-findings
evidence. Product #604 is in progress and SAST/Security #199 are queued;
...
| [#33](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/33) | `7922d9be1aca16a0ffbd59d44e0183dd2ef7155b` (2026-08-21) | Ready, stacked, review-required | Obligation applicability and regulatory-change model stacked on current PR #32 for Issue #28. Current head has 166 passing tests with 100% statement/branch/docstring coverage, Ruff, compile, lock, actionlint, Semgrep zero blocking findings, and a real PostgreSQL 18.6 migration/index/trigger/tenant/immutability probe. Product #608 is in progress and SAST/Security #201 are queued; independent approval remains outstanding. |
