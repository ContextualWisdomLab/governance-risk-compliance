...
| [#55](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/55) | `a6275068d84a6bc9e5d08a3ab7ab4ed99ea70826` (2026-08-23) | Ready, stacked on #38 | Keyverse HTTP adapter: Bearer RFC 9068 access tokens on policy/evidence routes, actor-header impersonation rejected, tenant header must match `org`, officer-scoped policy list/gaps. Local 102-test 100% statement/branch/docstring evidence. Must stay behind PR #38. |
...
keep PR #55 stacked on PR #38; merge ContextualWisdomLab/.github#1257;
continue Keyverse tenant-owned persistence after this HTTP adapter.
