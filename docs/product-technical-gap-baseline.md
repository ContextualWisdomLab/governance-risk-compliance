...
fork head is `92d8b41c8119a289663288008c42bfe6b68769e8`, including the sampled-off
traceparent repair, correlation headers, sanitized 500 responses, and explicit
ERROR status for handler-returned 5xx spans. The exact current tree passes 55
tests with 100% statement/branch/docstring coverage, Ruff, compile, lock,
package build/install smoke, actionlint, Semgrep (187 rules, zero findings),
and diff checks; hosted security and review lanes were recreated after the
latest fork push and remain pending. An older Security Scan at predecessor
