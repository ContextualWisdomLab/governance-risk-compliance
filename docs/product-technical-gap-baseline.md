...
Baseline source head: `8b4b563a073e6037dfe6f766709e587c2f553eda` (PR #49 exact head, stacked on PR #48)
Develop-based buyer-workspace head: `30db69b4bf0ef39654cfaba460c7d4ba66ecc91d`
Active reviewed security/model/catalog/obligation fix heads: PR #32 `c750cb8bdc347f4fc592e2e908f098520e16074f`, PR #33 `55afaee88fd0e9113a9fb655da1d2d95275c0e8c`, PR #37 `3f08db7fa7d67cb44515784bc5b331fe0d21f457`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, PR #40 `4daab149d364f6117e31df22e14e11ad35d230b2`, PR #41 `b855456e150c4aefc2434ccfdf43d77f387aa204`, PR #42 `b482f996deab5f69d3eed15e1d13d68c8de321c0`, PR #43 `f41c387c62998de2d136ce8f4a110b4cb22906ac`, PR #44 `ea53e6e213d6fc91358db295e11825e27f9cf38b`, PR #45 `96b1d11de1838d075189e29d2675e48f75d749a1`, PR #46 `237094609274be4af9e9820c51ba34949370403f`, PR #47 `3920a505b61cf3986fb5b8819a6cd9ab6b673920`, PR #48 `afc225e495a7beaaa2bf6924401abe1a80ed563c`, and PR #49 `8b4b563a073e6037dfe6f766709e587c2f553eda`. This baseline follow-up is PR #39.
...
approval evidence. PR #43 is Ready with hosted checks queued and no
...
MERGEABLE but Ready and blocked by fresh hosted checks and independent review;
...
#16, #18, #19, #32, #33, #37, #38, #40, #41, #42, #43, #44, #45, #46, #47, #48, and #49 were rechecked or reconstructed on 2026-08-21
...
| [#39](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/39) | `de571802239ba819b0fd5201993f2e20ddad5645` (2026-08-21) | Ready, merge-blocked, review-required | Current buyer-gap baseline follow-up targets `docs/product-technical-gap-baseline` at PR #19 exact parent head `de571802239ba819b0fd5201993f2e20ddad5645`; this row intentionally uses the immutable parent head while the child only edits this document. The corrected docs head records current Keyverse, evidence-lifecycle, operations, internal-control, obligation, catalog, buyer-workspace, automation, and observed-vs-inferred boundaries; it remains documentation evidence only. |
...
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `b855456e150c4aefc2434ccfdf43d77f387aa204` (2026-08-21) | Ready, merge-blocked, review-required | Replacement for closed PR #36 on current PR #32 head `c750cb8bdc347f4fc592e2e908f098520e16074f`. The branch carries the migration-SAST, local actor-boundary, and `grc.control.read` coverage fixes plus the parent review fixes. Local 165-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/diff checks, and Semgrep zero-findings evidence pass; new-head Product and required security/review lanes are queued. |
| [#42](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/42) | `b482f996deab5f69d3eed15e1d13d68c8de321c0` (2026-08-21) | Ready, mergeable, review-required | Organization OpenTelemetry acceptance-evidence boundary on current PR #32 head `c750cb8bdc347f4fc592e2e908f098520e16074f`. The exact docs head fixes the ADR sequence to 0012 and passes the 160-test 100% statement/branch/docstring suite (2,405 statements/576 branches), Ruff, lock, compile, actionlint, diff, and Semgrep zero-findings checks; hosted Product is terminal-success at this exact head, Devin findings are commented/dispositioned, and independent approval remains outstanding. |
| [#43](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/43) | `f41c387c62998de2d136ce8f4a110b4cb22906ac` (2026-08-21) | Ready, merge-blocked | Hourly central review-repair caller targeting `develop`, pinned to central workflow commit `55a8b576725451dfe0a21a57d36a2f1a41619b24`. Local 48-test 100% statement/branch/docstring, Ruff, compile, lock, actionlint, and Semgrep zero-blocking evidence pass; hosted Product is successful, `coverage-source-tree` is successful, and `coverage-evidence` remains queued. The Devin secret-forwarding note was dispositioned against the pinned OIDC contract; the organization target allowlist is observed configured, but two approving reviews, last-push approval, and protected merge remain outstanding. |
| [#44](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/44) | `ea53e6e213d6fc91358db295e11825e27f9cf38b` (2026-08-21) | Ready, mergeable, review-required | Compliance-workspace read model stacked on PR #33. It composes tenant-scoped controls, obligation work items, and policy gaps; distinguishes distinct obligations from scoped applicability/review work items; and batch-loads coverage in six tenant-scoped SQL queries. Local 173-test statement/branch/docstring, Ruff, compile, lock, actionlint, and Semgrep-zero evidence pass; hosted Product checks are successful at this exact head. Devin findings were dispositioned with multi-scope and query-bound tests; independent approvals, last-push approval, and protected merge remain outstanding. |
| [#45](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/45) | `96b1d11de1838d075189e29d2675e48f75d749a1` (2026-08-21) | Ready, mergeable, review-required | Evidence-request workflow stacked on current PR #44 exact head `ea53e6e213d6fc91358db295e11825e27f9cf38b`. It records scope/period/required fields/contributor/due/reuse policy, same-tenant submission, independent accept/reject, append-only audit history, and workspace state projection without payload duplication. Local 177-test 100% statement/branch/docstring, Ruff, compile, lock, actionlint, diff, Semgrep-zero, and real PostgreSQL 18.4 temporary-schema evidence pass; both hosted Product runs are terminal-success, Devin is pending, CodeRabbit is skipped for the non-default base, and no independent approval is present. |
| [#46](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/46) | `237094609274be4af9e9820c51ba34949370403f` (2026-08-21) | Ready, mergeable, review-required | Versioned risk methodology/register core stacked on PR #45 exact head `96b1d11de1838d075189e29d2675e48f75d749a1`. It records appetite/tolerance and named effectiveness method, immutable inherent/residual snapshots, optimistic revision, exact tenant control-test/evidence-use links, duplicate-mitigation rejection, and risk workspace projection. Local 183-test 100% statement/branch/docstring, Ruff, compile, lock, actionlint, build, Semgrep-zero, and real PostgreSQL 18.4 temporary-schema evidence pass; hosted Product is terminal-success, Devin is pending, CodeRabbit is skipped for the non-default base, and no independent approval is present. |
| [#47](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/47) | `3920a505b61cf3986fb5b8819a6cd9ab6b673920` (2026-08-21) | Ready, merge-blocked, review-required | Risk disposition workflow stacked on PR #46 exact head `237094609274be4af9e9820c51ba34949370403f`. It adds immutable versioned treatment plans restricted to above-appetite assessments, independent time-bounded acceptance with tolerance escalation, audit events, workspace projection, migration `0010_risk_disposition`, and SQLite/PostgreSQL guards. Local 185-test 100% statement/branch/docstring, build, lint, SAST, dependency, and PostgreSQL 18.4 evidence pass; hosted Product is terminal-success at this exact head, Devin findings were dispositioned/fixed, and no independent approval is present. |
| [#48](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/48) | `afc225e495a7beaaa2bf6924401abe1a80ed563c` (2026-08-21) | Ready, merge-blocked, review-required | Independent risk-closure approval stacked on PR #47 exact head `3920a505b61cf3986fb5b8819a6cd9ab6b673920`. It adds latest within-appetite closure, independent actor and opaque evidence reference requirements, migration `0011_risk_closure`, risk/workspace projections, SQLite/PostgreSQL immutability guards, and the closed-risk actionable-queue correction. Local 186-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/build, Semgrep zero, pip-audit clean, and PostgreSQL 18.4 evidence pass; hosted Product is terminal-success at this exact head and no independent approval is present. |
| [#49](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/49) | `8b4b563a073e6037dfe6f766709e587c2f553eda` (2026-08-21) | Ready, mergeable, review-required | Tenant-scoped risk portfolio indicators stacked on PR #48 exact head `afc225e495a7beaaa2bf6924401abe1a80ed563c`. It adds read-only status/category counts, bounded overdue and active-disposition indicators, excludes closed risks from overdue/actionable items, and explicitly avoids composite score arithmetic across methodology versions. Local 187-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/build, Semgrep zero, pip-audit clean, and PostgreSQL 18.4 workspace-route evidence pass; hosted Product, Devin, and CodeRabbit checks are terminal-success, and no independent approval is present. |
| [#19](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/19) | `de571802239ba819b0fd5201993f2e20ddad5645` (2026-08-21) | Ready, merge-blocked, review-required | Documentation baseline and GRC roadmap review fixes. The current head makes `not_applicable` require an exact authorized decision, maps applicable-without-implementation/evidence to `unknown`, records `posture-projection-v1` and input fact versions, and enumerates the complete release-gate token set. Product, SAST/Security, and required review lanes are terminal-success at this exact head; independent approval and protected merge remain outstanding. |
| [#16](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/16) | `d7f867f2d55b21e04f548446c4148c1fdfa7474a` (2026-08-21) | Ready, merge-blocked, review-required | Tenant isolation stacked behind current PR #7 exact head `174b83691b103a42607ec33ca5fc7225216744b6`. The exact integrated head has 120 tests, 1,311 statements, 332 branches, 100% coverage/docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings after replacing dynamic migration SQL with static tenant-column statements. Hosted checks and independent approval remain absent. |
| [#7](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/7) | `174b83691b103a42607ec33ca5fc7225216744b6` (2026-08-21) | Ready, merge-blocked, review-required | Route enforcement stacked behind current PR #6 exact head `b9b3d5c49367d0b128c87aa478d8921eb1f6c349`. The exact integrated head has 110 tests, 1,270 statements, 320 branches, 100% coverage/docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; hosted checks and independent approval remain absent. |
| [#6](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/6) | `b9b3d5c49367d0b128c87aa478d8921eb1f6c349` (2026-08-21) | Ready, merge-blocked, review-required | OIDC/JWKS loader stacked on direct-to-`develop` PR #38 exact head `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`. The exact integrated head has 97 tests, 1,251 statements, 314 branches, 100% coverage/docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; hosted checks and independent approval remain absent. |
