...
Active reviewed security/model/catalog/obligation fix heads: PR #32 `cf59f1cbc8d2c555f9d4f4bf9105f8a473b1111d`, PR #33 `7b7baaae8d33f5ac95afd35c0bc3dda41a22680c`, PR #37 `6a312a189cadec192c50b4cc5b09804d3a0e97e5`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, PR #40 `4daab149d364f6117e31df22e14e11ad35d230b2`, PR #41 `c3f36a4e5d6bb89d6a1de307fe13f045da78705d`, PR #42 `3a53ede49dae4daf0a7a1bf8a6f8866e17df3fd6`, and PR #43 `f41c387c62998de2d136ce8f4a110b4cb22906ac`. This baseline follow-up is PR #39.
...
current exact head `cf59f1cbc8d2c555f9d4f4bf9105f8a473b1111d` carries the latest
...
test projection, and time-frozen test fixes. The integrated local suite has 158 tests with 2,398 statements/576 branches and 100% statement/branch/docstring
...
#32. Its current exact head `7b7baaae8d33f5ac95afd35c0bc3dda41a22680c` is aligned
...
head `c3f36a4e5d6bb89d6a1de307fe13f045da78705d` has local 163-test 100%
...
`3a53ede49dae4daf0a7a1bf8a6f8866e17df3fd6` renumbers the decision record to
...
| [#32](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/32) | `cf59f1cbc8d2c555f9d4f4bf9105f8a473b1111d` (2026-08-21) | Ready, stacked, review-required | Internal-control model stacked on #31 for Issue #27. The corrected exact head has 158 tests, 2,398 statements, 576 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; time-sensitive coverage assertions are frozen against the wall clock, and inactive/incomplete test results are excluded from coverage. Current-head review threads remain subject to the post-push hosted review, while terminal hosted checks, two approving reviews, and last-push approval remain required. No current PostgreSQL probe is claimed. |
| [#33](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/33) | `7b7baaae8d33f5ac95afd35c0bc3dda41a22680c` (2026-08-21) | Ready, stacked, review-required | Obligation applicability and regulatory-change model stacked on current PR #32 for Issue #28. The corrected exact head has 169 tests, 2,971 statements, 666 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; current-head review threads are resolved, while the predecessor PostgreSQL probe/hosted results do not transfer and terminal checks, two approvals, last-push approval, and protected merge remain required. |
...
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `c3f36a4e5d6bb89d6a1de307fe13f045da78705d` (2026-08-21) | Draft, stacked, review-required | Replacement for closed PR #36 on current PR #32 head `cf59f1cbc8d2c555f9d4f4bf9105f8a473b1111d`. The two exact-head Semgrep findings in migration SQL are replaced with SQLAlchemy-safe structured constructs; the branch also carries owner-graph, race, coverage, request-identity, approved-exception, deterministic-ordering, bounded-identifier, inactive/incomplete-test projection, and time-frozen test fixes. Local 163-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/diff checks, and Semgrep zero-findings evidence pass. New-head Product jobs are successful; SAST/Security/Strix and required workflows are queued, and independent approval remains outstanding. |
| [#42](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/42) | `3a53ede49dae4daf0a7a1bf8a6f8866e17df3fd6` (2026-08-21) | Ready, stacked, review-required | Organization OpenTelemetry acceptance-evidence boundary on current PR #32 head `cf59f1cbc8d2c555f9d4f4bf9105f8a473b1111d`. The exact docs head fixes the ADR sequence to 0012 and, after parent integration, passes the 158-test 100% statement/branch/docstring suite (2,398 statements/576 branches), Ruff, lock, compile, actionlint, diff, and Semgrep zero-findings checks. New-head hosted checks and independent approval remain outstanding. |
