...
| G-07 | P1 | The product cannot register, assess, treat, accept, monitor, and close risk through reviewed control-effectiveness truth. | PR #46 exact head `237094609274be4af9e9820c51ba34949370403f` adds a tenant risk register, immutable methodology-versioned inherent/residual assessments, appetite/tolerance thresholds, named effectiveness method, optimistic revision, and non-duplicated mitigation links through implemented internal controls, completed test results, and purpose-bound evidence usage. Local 183-test 100% statement/branch/docstring, real PostgreSQL 18.4, and static/security checks pass; both hosted Product checks are currently in progress, Devin is pending, CodeRabbit is skipped for this non-default base, and no independent approval is present. | Add versioned treatment plans, time-bounded acceptance above appetite, risk indicators/escalation, portfolio aggregation, closure approval, and protected merge/revalidation. | [Issue #13](https://github.com/ContextualWisdomLab/governance-risk-compliance/issues/13) |
...
| [#46](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/46) | `237094609274be4af9e9820c51ba34949370403f` (2026-08-21) | Ready, mergeable, review-required | Versioned risk methodology/register core stacked on PR #45 exact head `96b1d11de1838d075189e29d2675e48f75d749a1`. It records appetite/tolerance and named effectiveness method, immutable inherent/residual snapshots, optimistic revision, exact tenant control-test/evidence-use links, duplicate-mitigation rejection, and risk workspace projection; treatment and acceptance remain explicit gaps. Local 183-test 100% statement/branch/docstring, Ruff, compile, lock, actionlint, build, Semgrep-zero, and real PostgreSQL 18.4 temporary-schema evidence pass; both hosted Product runs are in progress, Devin is pending, CodeRabbit is skipped for the non-default base, and no independent approval is present. |
