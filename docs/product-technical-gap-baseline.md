...
Product, CodeQL, SAST, Security, Strix, and required review workflows are
queued after this exact-head push; it remains unmerged and has no independent
formal approval.
