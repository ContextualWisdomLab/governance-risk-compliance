...
evidence, and the latest hosted observation is 17 success, 1 queued, and 8
skipped checks after the changelog repair; Required OpenCode Review
`coverage-source-tree` remains queued; independent approval and last-push
