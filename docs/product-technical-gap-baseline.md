...
| [#54](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/54) | `b6d85820bd3cb2a0f1b337225296fa857a85f494` (2026-08-22) | Open, stacked, dependency-ordered | Buyer-gap slice stacked on PR #34 branch head `eafa57c07cbbf405d4d60c914e2a76e557037437`; adds local-only `GET /workspace/posture` with exact official-control counts, legacy-evidence-only `unknown` rows, policy-gap count, explicit Keyverse/tenant-authorization limitation, and zero effective controls until internal-control effectiveness exists. The exact head has 56 passing tests with 100% statement/branch/docstring coverage, Ruff, compile, lock, actionlint, Semgrep zero findings, pip-audit clean, and two hosted Product checks successful; it must remain behind PR #34 and normal review/check gates. |
