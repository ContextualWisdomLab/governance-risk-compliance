...
Active reviewed security/model/catalog/obligation fix heads: PR #32 `e9e0e90611796e4340dc0c99af2a13c9dfa2a13b`, PR #33 `161e183c97d2b52ebd32b66bb29887385121d537`, PR #37 `bfb3f61767886075be32b669871cc4b21b168708`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, PR #40 `4daab149d364f6117e31df22e14e11ad35d230b2`, and PR #41 `4ab0046b5e67fc98482305978ae48e156d80e6f5`. This baseline follow-up is PR #39.
...
current exact head `e9e0e90611796e4340dc0c99af2a13c9dfa2a13b` adds the latest
operating-result review fix and the migration DDL SAST fix. Exact-head Product
#596 is in progress and SAST/Security #195 are queued; local 154-test 100%
...
head `4ab0046b5e67fc98482305978ae48e156d80e6f5` has local 158-test 100%
statement/branch/docstring evidence, actionlint, and Semgrep zero-findings
evidence. Fresh external gates and independent formal approval remain
outstanding.
...
#16, #18, #19, #32, and #41 were rechecked or reconstructed on 2026-08-21
...
| --- | --- | --- | --- |
| [#18](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/18) | `a61767adc8fe317243e0068274f2ec60841dc796` | Ready, mergeable, review-required | Current head includes the two-test import-style review fix in addition to PostgreSQL acceptance cleanup and statement-time trigger assertions. Local full coverage, Ruff, and Interrogate pass; predecessor Product/PostgreSQL/SAST/Security results do not transfer, fresh exact-head checks are not yet returned, and independent approval remains required. The earlier Strix high finding remains documented as a false positive by exact-source review because `require_purpose` fails closed and every protected mutation consumes the accepted decision. |
...
| [#32](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/32) | `e9e0e90611796e4340dc0c99af2a13c9dfa2a13b` (2026-08-21) | Ready, stacked, review-required | Internal-control model stacked on #31 for Issue #27. The current head fixes latest-operating-result staleness and the migration DDL SAST findings; local 154-test 100% statement/branch/docstring, actionlint, and Semgrep zero-findings evidence pass. Product #596 is in progress and SAST/Security #195 are queued; predecessor Product #468 does not transfer and independent approval remains required. |
...
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `4ab0046b5e67fc98482305978ae48e156d80e6f5` (2026-08-21) | Draft, stacked, review-required | Replacement for closed PR #36 on the current PR #32 head. The two exact-head Semgrep findings in migration SQL are replaced with SQLAlchemy `DDL`/`Index` constructs; the branch also carries the owner-graph, race, and coverage review fixes. Local 158-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/diff checks, and Semgrep zero-findings evidence pass. Fresh external gates and independent approval remain outstanding. |
