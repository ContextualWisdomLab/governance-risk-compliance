...
Active reviewed security/model/catalog/obligation fix heads: PR #32 `63c28387f2c3707e3ffb98ac6a7649bf65fe65cb`, PR #33 `d474c0236e83edb8d56189064cca397f425a6a08`, PR #37 `6a312a189cadec192c50b4cc5b09804d3a0e97e5`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, PR #40 `4daab149d364f6117e31df22e14e11ad35d230b2`, PR #41 `0b390d05c5d61d70c996db0752086e5962567264`, PR #42 `8b3012c44a67a2d6a2b6bdf0c41789d0063d6092`, and PR #43 `f41c387c62998de2d136ce8f4a110b4cb22906ac`. This baseline follow-up is PR #39.
...
current exact head `63c28387f2c3707e3ffb98ac6a7649bf65fe65cb` carries the latest
operating-result, owner-graph, migration-SAST, approved-exception, deterministic
ordering, bounded legacy-identifier, idempotent-backfill, and time-frozen test
fixes. The integrated local suite has 158 tests with 2,398 statements/576 branches and 100% statement/branch/docstring
...
#32. Its current exact head `d474c0236e83edb8d56189064cca397f425a6a08` is aligned
...
integrated local suite has 169 tests with 2,971 statements/666 branches and
...
head `0b390d05c5d61d70c996db0752086e5962567264` has local 163-test 100%
...
`8b3012c44a67a2d6a2b6bdf0c41789d0063d6092` renumbers the decision record to
the sequential ADR 0012 after a current-head review finding and carries the
latest parent stack. The integrated 158-test head passes 2,398 statements/576
...
| [#32](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/32) | `63c28387f2c3707e3ffb98ac6a7649bf65fe65cb` (2026-08-21) | Ready, stacked, review-required | Internal-control model stacked on #31 for Issue #27. The corrected exact head has 158 tests, 2,398 statements, 576 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; time-sensitive coverage assertions are frozen against the wall clock. Current-head review threads are resolved, while terminal hosted checks, two approving reviews, and last-push approval remain required. No current PostgreSQL probe is claimed. |
| [#33](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/33) | `d474c0236e83edb8d56189064cca397f425a6a08` (2026-08-21) | Ready, stacked, review-required | Obligation applicability and regulatory-change model stacked on current PR #32 for Issue #28. The corrected exact head has 169 tests, 2,971 statements, 666 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; current-head review threads are resolved, while the predecessor PostgreSQL probe/hosted results do not transfer and terminal checks, two approvals, last-push approval, and protected merge remain required. |
...
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `0b390d05c5d61d70c996db0752086e5962567264` (2026-08-21) | Draft, stacked, review-required | Replacement for closed PR #36 on current PR #32 head `63c28387f2c3707e3ffb98ac6a7649bf65fe65cb`. The two exact-head Semgrep findings in migration SQL are replaced with SQLAlchemy-safe structured constructs; the branch also carries owner-graph, race, coverage, request-identity, approved-exception, deterministic-ordering, bounded-identifier, and time-frozen test fixes. Local 163-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/diff checks, and Semgrep zero-findings evidence pass. New-head Product jobs are successful; SAST/Security/Strix and required workflows are queued, and independent approval remains outstanding. |
| [#42](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/42) | `8b3012c44a67a2d6a2b6bdf0c41789d0063d6092` (2026-08-21) | Ready, stacked, review-required | Organization OpenTelemetry acceptance-evidence boundary on current PR #32 head `63c28387f2c3707e3ffb98ac6a7649bf65fe65cb`. The exact docs head fixes the ADR sequence to 0012 and, after parent integration, passes the 158-test 100% statement/branch/docstring suite (2,398 statements/576 branches), Ruff, lock, compile, actionlint, diff, and Semgrep zero-findings checks. New-head hosted checks and independent approval remain outstanding. |
