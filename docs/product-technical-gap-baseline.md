...
PostgreSQL temporary-schema evidence pass; hosted Product is split between
one in-progress and one queued run, Devin is pending, CodeRabbit is skipped on
the non-default base, and independent approval is absent.
...
#16, #18, #19, #32, #33, #37, #38, #40, #41, #42, #43, #44, and #45 were rechecked or reconstructed on 2026-08-21
...
| [#45](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/45) | `96b1d11de1838d075189e29d2675e48f75d749a1` (2026-08-21) | Ready, mergeable, checks-pending, review-required | Evidence-request workflow stacked on current PR #44 exact head `ea53e6e213d6fc91358db295e11825e27f9cf38b`. It records scope/period/required fields/contributor/due/reuse policy, same-tenant submission, independent accept/reject, append-only audit history, and workspace state projection without payload duplication. Local 177-test 100% statement/branch/docstring, Ruff, compile, lock, actionlint, diff, Semgrep-zero, and real PostgreSQL 18.4 temporary-schema evidence pass; one hosted Product run is in progress, one is queued, Devin is pending, CodeRabbit is skipped for the non-default base, and no independent approval is present. |
