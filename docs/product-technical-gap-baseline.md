...
Active reviewed security/model/catalog/obligation fix heads: PR #33 `c4e5c23ffda65854347a720d9332daa87eed9da1`, PR #36 `cb1a48395109c87c17ad287ea1fc81dc25b135e1`, PR #37 `221af68eb1263d077e7ebcba28611ff54e07e885`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, and PR #40 `9bff870e8b540e49745e3c48f39caa6de96ccbf2`. This baseline follow-up is PR #39.
...
#32. Its current exact head `c4e5c23ffda65854347a720d9332daa87eed9da1` adds the
...
Its exact head `221af68eb1263d077e7ebcba28611ff54e07e885` has local 69-test,
100% statement/branch/docstring evidence and a real PostgreSQL 18.6 catalog
source/version/import/receipt/release probe. It deliberately does not claim
remote fetching, OSCAL/OLIR parsing, or `control_framework` publication; it
remains Draft with no independent formal approval.
...
| [#37](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/37) | `221af68eb1263d077e7ebcba28611ff54e07e885` | Draft, mergeable, review-required | Issue #29 catalog-provenance slice on `develop`. Local 69-test 100% evidence and PostgreSQL 18.6 catalog probes pass; scope excludes remote source retrieval and OSCAL/OLIR parsing, and required/security gates plus independent approval remain outstanding. |
