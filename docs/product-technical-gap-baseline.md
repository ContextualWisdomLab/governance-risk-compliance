...
| G-07 | P1 | The product cannot register, assess, treat, accept, monitor, and close risk through reviewed control-effectiveness truth. | PR #47 exact head `3920a505b61cf3986fb5b8819a6cd9ab6b673920` adds immutable versioned treatment plans restricted to above-appetite assessments, independent current/future-ending above-appetite acceptance, escalation above tolerance, audit events, and disposition projection. PR #48 exact head `d56793231a3ce37671ab3e463e7516e6cfdd8f1f` adds independent closure approval for the latest within-appetite reassessment, closure evidence references, migration `0011_risk_closure`, and PostgreSQL/SQLite immutability guards. PR #49 exact head `5e6f5bb20d069b9a3417b83fdb877dd56b80acfb` adds tenant-scoped portfolio indicators with status/category breakdowns and bounded active/overdue counts without cross-methodology score arithmetic; closed risks remain visible for audit but leave the actionable queue. Local 187-test 100% statement/branch/docstring, real PostgreSQL 18.4, build, lint, SAST, and dependency checks pass; PR #49 hosted Checks are newly in progress and no independent approval is present. | Add treatment completion/reassessment evidence, any reviewed score normalization, and protected merge/revalidation. | [Issue #13](https://github.com/ContextualWisdomLab/governance-risk-compliance/issues/13) |
...
#16, #18, #19, #32, #33, #37, #38, #40, #41, #42, #43, #44, #45, and #46 were rechecked or reconstructed on 2026-08-21
...
| [#48](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/48) | `d56793231a3ce37671ab3e463e7516e6cfdd8f1f` (2026-08-21) | Ready, merge-blocked, review-required | Independent risk-closure approval stacked on PR #47 exact head `3920a505b61cf3986fb5b8819a6cd9ab6b673920`. It adds latest within-appetite closure, independent actor and opaque evidence reference requirements, migration `0011_risk_closure`, risk/workspace projections, and SQLite/PostgreSQL immutability guards. Local 186-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/build, Semgrep zero, pip-audit clean, and PostgreSQL 18.4 evidence pass; hosted Product is terminal-success at this exact head, the closed-risk retention note is dispositioned, and no independent approval is present. |
| [#49](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/49) | `5e6f5bb20d069b9a3417b83fdb877dd56b80acfb` (2026-08-21) | Checks-pending, review-required | Tenant-scoped risk portfolio indicators stacked on PR #48 exact head `d56793231a3ce37671ab3e463e7516e6cfdd8f1f`. It adds read-only status/category counts, bounded overdue and active-disposition indicators, excludes closed risks from overdue/actionable items, and explicitly avoids composite score arithmetic across methodology versions. Local 187-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/build, Semgrep zero, pip-audit clean, and PostgreSQL 18.4 workspace-route evidence pass; hosted Product is newly in progress and no independent approval is present. |
