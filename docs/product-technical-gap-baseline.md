...
| [#49](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/49) | `4861a1e2d88151cfca86006fd0db1455b98e6746` (2026-08-21) | Checks-pending, review-required | Tenant-scoped risk portfolio indicators stacked on PR #48 exact head `d56793231a3ce37671ab3e463e7516e6cfdd8f1f`. It adds read-only status/category counts, bounded overdue and active-disposition indicators, and explicitly avoids composite score arithmetic across methodology versions. Local 187-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/build, Semgrep zero, pip-audit clean, and PostgreSQL 18.4 workspace-route evidence pass; hosted Product is in progress and no independent approval is present. |
