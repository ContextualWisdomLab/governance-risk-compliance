...
and `GET /catalog/releases`. Product #616 is in progress and SAST/Security
...
| [#37](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/37) | `b685cd739efa1f5d285b821676e841b6a629186d` (2026-08-21) | Draft, mergeable, review-required | Issue #29 catalog-provenance slice on `develop`. Current head adds the governed `GET /catalog/releases` review list; local 69-test 100% statement/branch/docstring, Ruff, compile, lock, actionlint, diff, and Semgrep zero-blocking evidence pass, plus a PostgreSQL 18.6 migration and endpoint probe. Product #616 is in progress and SAST/Security #205 are queued; scope excludes remote source retrieval and OSCAL/OLIR parsing, and independent approval remains outstanding. |
