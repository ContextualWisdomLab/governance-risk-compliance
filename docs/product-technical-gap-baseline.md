...
Active reviewed security/model/catalog/obligation fix heads: PR #33 `161e183c97d2b52ebd32b66bb29887385121d537`, PR #36 `cb1a48395109c87c17ad287ea1fc81dc25b135e1`, PR #37 `bfb3f61767886075be32b669871cc4b21b168708`, PR #38 `0c4084705b4f86913acdefa1ada3d17aa2d1e6f7`, and PR #40 `4daab149d364f6117e31df22e14e11ad35d230b2`. This baseline follow-up is PR #39.
...
| [#32](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/32) | `5a2a07f636ed95a4bf23a916e9d84cab2a6230ae` (2026-08-21) | Ready, stacked, review-required | Internal-control model stacked on #31 for Issue #27. The source tree is content-equivalent to prior head `138c833`; predecessor Product #468 does not transfer after branch-history repair. Fresh exact-head checks and independent approval remain required. |
...
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `1979f9a44ca934bcf0ed44fa4e4330dd3a09ecfb` (2026-08-21) | Draft, stacked, review-required | Replacement for closed PR #36 on current PR32 head. The two exact-head Semgrep findings in migration SQL are replaced with SQLAlchemy `DDL`/`Index` constructs; local 157-test 100% evidence, full lint/docstring/compile/lock/actionlint/diff checks, and local Semgrep zero findings pass. Fresh external gates and independent approval remain outstanding. |
