...
Active operations stack heads: PR #22 `f3a89c9aa2713e69187debf9a46cb29747dad532`, PR #23 `84da36f67f59cddc93b703a1aa2b1328a89ef369`, PR #24 `42f798718bc88480819792eec5c673e76ab2074f`, PR #25 `9fe8b484c1a83c3ee2a06e12ddd46f0e06a25b70`, PR #26 `edac92339997e06530b863718edcaac4038e9460`, and PR #31 `a70debe55dec9286c571bb785827c7fc88e3694f`, stacked on PR #21 in that order.
...
rejection. Product #608, SAST Semgrep, and Security Scan are successful on this
exact head; Strix is successful and coverage-source-tree is queued. Current
head review threads are resolved, but two approving reviews and last-push
approval remain absent. It remains unmerged and depends on PR #32's protected
review gate.
...
head `246297082431aefc8281f3c6e1947b961298638f` has local 160-test 100%
statement/branch/docstring evidence, actionlint, and Semgrep zero-findings
...
`7f464d9ff3019477c7db81ebee240fb8d722a091` renumbers the decision record to
the sequential ADR 0012 after a current-head review finding. The docs-only
head passes the inherited 155-test 100% statement/branch/docstring suite,
Ruff, lock, compile, actionlint, diff, and Semgrep zero-findings checks.
Product is successful on this exact head; CodeQL, SAST, Security, Strix, and
...
| [#22](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/22) | `f3a89c9aa2713e69187debf9a46cb29747dad532` | Draft, stacked, review-required | Operational readiness slice stacked on #21. The integrated exact head has 140 tests, 1,779 statements, 464 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; hosted checks and independent approval remain required. |
| [#23](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/23) | `84da36f67f59cddc93b703a1aa2b1328a89ef369` | Draft, stacked, review-required | Request telemetry stacked on #22. The integrated exact head has 143 tests, 1,849 statements, 470 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; collector acceptance, database/pool/recovery metrics, SLO, paging, restore/rollback, hosted checks, and independent approval remain. |
| [#24](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/24) | `42f798718bc88480819792eec5c673e76ab2074f` | Draft, stacked, review-required | Database transaction telemetry stacked on #23. The integrated exact head has 145 tests, 1,875 statements, 474 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; pool/recovery signals, collector acceptance, SLO, paging, recovery rehearsal, hosted checks, and independent approval remain. |
| [#25](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/25) | `9fe8b484c1a83c3ee2a06e12ddd46f0e06a25b70` | Draft, stacked, review-required | Proposed SLO/error-budget policy stacked on #24. The integrated exact head has 145 tests, 1,875 statements, 474 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; service-owner approval, collector delivery, recording rules, dashboards, paging, recovery rehearsal, hosted checks, and exact-head acceptance remain. |
| [#26](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/26) | `edac92339997e06530b863718edcaac4038e9460` | Draft, stacked, review-required | Bounded database-pool telemetry stacked on #25. The integrated exact head has 146 tests, 1,888 statements, 480 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; database exporter wiring, dashboards, alert routing, hosted checks, and independent approval remain. |
| [#31](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/31) | `a70debe55dec9286c571bb785827c7fc88e3694f` | Draft, stacked, review-required | Recovery-event telemetry stacked on #26. The integrated exact head has 147 tests, 1,898 statements, 484 branches, 100% public docstrings, full lint/compile/lock/actionlint, and Semgrep zero findings; recovery rehearsal, collector/dashboard wiring, alert routing, service-owner acceptance, hosted checks, and production recovery evidence remain. |
...
| [#33](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/33) | `7922d9be1aca16a0ffbd59d44e0183dd2ef7155b` (2026-08-21) | Ready, stacked, review-required | Obligation applicability and regulatory-change model stacked on current PR #32 for Issue #28. Current head has 166 passing tests with 100% statement/branch/docstring coverage, Ruff, compile, lock, actionlint, Semgrep zero blocking findings, and a real PostgreSQL 18.6 migration/index/trigger/tenant/immutability probe. Product #608, SAST Semgrep, Security Scan, Strix, and the other listed security/review workflows are successful; `coverage-source-tree` is queued. Current-head review threads are resolved; two approving reviews plus last-push approval remain outstanding. |
...
| [#39](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/39) | `6302a4e4d7217117357f43d373c5654cccce46c5` | Draft, direct to current PR #19 base, review-required | Current buyer-gap baseline follow-up now targets `docs/product-technical-gap-baseline` at PR #19 exact head `de571802239ba819b0fd5201993f2e20ddad5645`; stale conflicting PR #35 was superseded and closed. The reconciled docs head records current PR #6/#7/#16 Keyverse stack heads, PR #43 automation, and observed-vs-inferred boundaries; it remains documentation evidence only. |
