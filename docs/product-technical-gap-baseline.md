...
| G-07 | P1 | The product cannot register, assess, treat, accept, monitor, and close risk through reviewed control-effectiveness truth. | PR #47 exact head `92c3a8e0c6eb11c21eb5a0774f00516b28e1ff9f` adds immutable versioned treatment plans, independent current/future-ending above-appetite acceptance, escalation above tolerance, audit events, risk disposition projection, and PostgreSQL/SQLite immutability guards on top of PR #46. Local 185-test 100% statement/branch/docstring, real PostgreSQL 18.4, build, lint, SAST, and dependency checks pass; hosted Product has one queued and one in-progress run on this exact head, Devin is pending, CodeRabbit is skipped for this non-default base, and no independent approval is present. | Add risk indicators, portfolio aggregation, closure approval, and protected merge/revalidation. | [Issue #13](https://github.com/ContextualWisdomLab/governance-risk-compliance/issues/13) |
...
| [#47](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/47) | `92c3a8e0c6eb11c21eb5a0774f00516b28e1ff9f` (2026-08-21) | Ready, mergeable, review-required | Risk disposition workflow stacked on PR #46 exact head `237094609274be4af9e9820c51ba34949370403f`. It adds immutable versioned treatment plans, independent time-bounded acceptance with tolerance escalation, audit events, workspace projection, migration `0010_risk_disposition`, and SQLite/PostgreSQL guards. Local 185-test 100% statement/branch/docstring, build, lint, SAST, dependency, and PostgreSQL 18.4 temporary-schema evidence pass; hosted Product is queued/in-progress on this exact head, Devin is pending, CodeRabbit is skipped for the non-default base, and no independent approval is present. |
