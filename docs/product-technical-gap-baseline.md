...
Active evidence-lifecycle stack heads: PR #20 `e91b2384177451ebf80858e518d729e258c40f00` and PR #21 `04facc110a7437f7a86b8572707ffb5f65e0515e`, stacked on PR #16 in that order. PR #21's current head includes the stack-only merge of PR #22.
PR #22 `9c1923e8e6f6145d0f789a97db4dd15f94f2adf3` was merged into PR #21's feature branch at `04facc110a7437f7a86b8572707ffb5f65e0515e`. Child PR #50 `ba78e4790f3e361826991455ce83634004f2875d` was then restacked normally onto PR #21's feature branch; PRs #23–#26 and #31 remain historical feature-branch merges.
...
`develop`. Its exact head `59e1a3cce5a794f1b6a33a9f5128a1ccccf95109` records the
...
base. Its exact head `ed1e82a40febb2f092723f1f247fd40e72a4833f` is normally
restacked on base `8881d3966e3e9da29b8dce990a95295a2780618b`, with verified
merge-result tree `e2f7340a747172ef455dd5c1a847bd28f689273f` and local 165-test
...
Its current exact head `fc647fbb288499a1492ed7313209195dd113677c` adds the
...
77 passing tests with 100% statement/branch/docstring coverage, Ruff, compile,
...
`8f9c37108ffb16519f2af7f559cba69fc1a40f3d` adds an optional caller-owned,
atomic JTI replay guard and enforces scope authorization before replay-token
consumption. The exact head has 98 local tests with 100% statement/branch/
docstring coverage; hosted checks were re-created after the latest security
repair and remain pending, with no independent approval or last-push approval.

PR #51 adds the GRC OpenTelemetry request boundary on `develop`. Its current
fork head is `b222cbf1cebe227fae95b3c53406e0604af4e797`, including the sampled-off
traceparent repair and correlation headers plus sanitized 500 responses. The
exact current tree passes 53 tests with 100% statement/branch/docstring
coverage, Ruff, compile, lock, package build, and diff checks; hosted security
and review lanes were recreated after the fork merge and remain pending.
...
| G-11 | P1 | A buyer lacks a role-aware compliance workspace, evidence request room, external-auditor data room, and controlled export. | PR #34 exact head `59e1a3cce5a794f1b6a33a9f5128a1ccccf95109` carries the Figma/Storybook authority, semantic design tokens, exact-value and next-action fixture states, lockfile/Node pinning, Chromium interaction evidence, rendered desktop-header/content and mobile layout repair, and English/Korean i18n contract; the stack-only PR #40 pinned the local Playwright binary, and historical PR #45 added a tenant-scoped request/submission/review workflow on another feature branch. The UI remains a static local preview and no protected merge is observed. | Deliver tenant- and purpose-scoped posture, traceability, real evidence requests, action queues, accessible exact-value views, reproducible CSV/JSON/PDF exports, i18n consistency, and expiring/revocable auditor packages. | [Issue #30](https://github.com/ContextualWisdomLab/governance-risk-compliance/issues/30) |
...
on 2026-08-22. Pull requests are excluded and listed separately below. All 13
...
were rechecked on 2026-08-22 after their current-head or branch-boundary
...
| --- | --- | --- | --- |
| [#18](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/18) | `35d3e55ccd2c5e89efec6c28b7613f1d605cac13` (2026-08-22) | Ready, merge-blocked, review-required | Exact-head local suite, 100% statement/branch/docstring coverage, Ruff, Interrogate, compile, and diff checks pass. Hosted Product/schema/security lanes are progressing, but the current Strix run and independent approval remain outstanding. |
| [#17](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/17) | `e0b84fea21b179138196a4d25a321049fad1d7f3` (2026-08-22) | Ready, merge-blocked, review-required | Exact-head local suite has 115 passing tests with 100% statement/branch coverage; the evidence index now binds component Git blob coordinates. Hosted required runs are present but queued, and no independent approval or last-push approval exists. |
...
| [#21](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/21) | `04facc110a7437f7a86b8572707ffb5f65e0515e` (2026-08-21) | Ready, merge-blocked, review-required | Retention and legal hold stacked on current PR #20 exact head `e91b2384177451ebf80858e518d729e258c40f00`; the current head also contains PR #22's stack-only operational merge. Product checks are successful on this head, while independent approval and the protected merge gate remain absent. Earlier local evidence for `0d7038da...` does not transfer. |
...
| [#34](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/34) | `59e1a3cce5a794f1b6a33a9f5128a1ccccf95109` (2026-08-22) | Ready, merge-blocked, review-required | Issue #30 buyer-workspace design authority on `develop`. The current non-Draft head retains local Python/UI evidence and terminal hosted product/security evidence, but required review evidence and independent approval remain absent. |
| [#37](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/37) | `fc647fbb288499a1492ed7313209195dd113677c` (2026-08-22) | Ready, merge-blocked, review-required | Issue #29 catalog-provenance slice on `develop`; the current repair accepts explicit HTTPS `:443` while rejecting non-default ports. Exact-head local evidence is 77 passing tests with 100% statement/branch/docstring coverage and quality/build checks green. Hosted required runs were recreated after this push; independent approval is absent. |
| [#38](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/38) | `8f9c37108ffb16519f2af7f559cba69fc1a40f3d` (2026-08-22) | Ready, merge-blocked, review-required | Replacement for closed PR #5. The exact head adds the optional caller-owned atomic JTI replay guard and scope-before-consume ordering; local evidence is 98 passing tests with 100% statement/branch/docstring coverage, while hosted runs and independent approval remain pending. |
...
| [#40](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/40) | `4daab149d364f6117e31df22e14e11ad35d230b2` (2026-08-21) | Ready, merge-blocked, review-required | Scorecard pinned-dependencies fix for PR #34. A normal merge commit brings the current PR34 base into the child; the stacked diff remains one workflow-line change. Local Python 53-test/100% coverage, Interrogate 100%, Storybook, actionlint, and three browser tests pass; current OpenCode review is queued and independent approval is absent. |
| [#41](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/41) | `ed1e82a40febb2f092723f1f247fd40e72a4833f` (2026-08-22) | Ready, merge-blocked, review-required | Replacement for closed PR #36, normally restacked on feature base `8881d3966e3e9da29b8dce990a95295a2780618b`; verified merge-result tree `e2f7340a747172ef455dd5c1a847bd28f689273f`. Local 165-test 100% statement/branch/docstring, Ruff, compile, lock, package, actionlint, Semgrep, and wheel-install evidence passes; hosted review remains pending and independent approval is absent. |
...
| [#19](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/19) | Current document branch head (re-query before merge) | Ready, merge-blocked, review-required | Documentation baseline and GRC roadmap review fixes. This branch records the 2026-08-22 open-issue snapshot and all nine live open PRs with exact heads, including the #37, #38, #43, and #51 follow-ups; the self-referential document head is intentionally not copied into its own row. Independent approval and protected merge remain absent. |
| [#51](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/51) | `b222cbf1cebe227fae95b3c53406e0604af4e797` (2026-08-22) | Ready, merge-blocked, review-required | GRC OpenTelemetry request boundary from the fork source. Exact-head local evidence is 53 passing tests with 100% statement/branch/docstring coverage, Ruff, compile, lock, package build, and diff checks; hosted security/review lanes were recreated after the fork merge and independent approval is absent. |
