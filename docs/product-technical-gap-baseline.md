...
| [#54](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/54) | `22ca705ee4b178069e18175644219937e1e9bc73` (2026-08-23) | Draft, stacked, restacked by merge | Officer-gap slice restacked onto current PR #34 head `ed1e6222df0ff021fb72d40d79a242bae71754c4` without rewriting published commits; adds local-only `GET /workspace/posture` with exact official-control counts, legacy-evidence-only `unknown` rows, policy-gap count, catalog edition/source provenance, exact policy-gap rows, explicit Keyverse/tenant-authorization limitation, and zero effective controls until internal-control effectiveness exists. It remains Draft and must stay behind PR #34 plus independent review. |
...
direct-to-`develop` PRs; keep Draft PR #54 stacked on PR #34
`ed1e6222df0ff021fb72d40d79a242bae71754c4`; repair fork PR #51 OSV compare via
the central `.github` artifact contract rather than a source revert; continue
G-11 tenant-scoped posture and G-01 Keyverse identity on the owning contracts.
