...
| [#48](https://github.com/ContextualWisdomLab/governance-risk-compliance/pull/48) | `d56793231a3ce37671ab3e463e7516e6cfdd8f1f` (2026-08-21) | Ready, checks-pending, review-required | Independent risk-closure approval stacked on PR #47 exact head `3920a505b61cf3986fb5b8819a6cd9ab6b673920`. It adds latest within-appetite closure, independent actor and opaque evidence reference requirements, migration `0011_risk_closure`, risk/workspace projections, and SQLite/PostgreSQL immutability guards. Local 186-test 100% statement/branch/docstring, full lint/compile/lock/actionlint/build, Semgrep zero, pip-audit clean, and PostgreSQL 18.4 evidence pass; hosted Product is queued on this exact head, the closed-risk retention note is dispositioned, and no independent approval is present. |
