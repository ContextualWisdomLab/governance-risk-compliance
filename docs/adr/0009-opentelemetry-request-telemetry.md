...
and error status without exception events or raw exception values. This slice is
verified with the isolated application boundary; live collector delivery and
PostgreSQL acceptance remain deployment checks.
