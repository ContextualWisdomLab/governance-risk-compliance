...
def test_require_purpose_accepts_only_declared_codes() -> None:
    allowed = require_purpose("officer-ahn", PurposeCode.EVIDENCE_BINDING.value, PurposeCode.EVIDENCE_BINDING)
...
def test_require_purpose_rejects_blank_actor() -> None:
    try:
        require_purpose("", PurposeCode.EVIDENCE_BINDING.value, PurposeCode.EVIDENCE_BINDING)
...
def test_main_binds_all_interfaces(monkeypatch) -> None:
...
def test_require_purpose_rejects_mismatched_purpose() -> None:
    try:
        require_purpose("officer-ahn", PurposeCode.COVERAGE_REVIEW.value, PurposeCode.EVIDENCE_BINDING)
    except Exception as exc:
