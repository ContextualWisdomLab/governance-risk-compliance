...
| OpenTelemetry telemetry | Standard OTLP endpoint from `OTEL_EXPORTER_OTLP_ENDPOINT`; request and session-transaction metrics use bounded attributes; no endpoint means bounded local collection for tests/developer diagnostics |
