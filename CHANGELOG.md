...
- Scoped the local `/workspace/posture` projection to the declared officer, hiding other officers' policy gaps and legacy evidence while still requiring Keyverse before remote exposure and tenant-based scoping.
