...
- Bounded catalog release review pages with deterministic ordering, status filtering, explicit pagination state, governed detail snapshots, and published-only comparison guards.
